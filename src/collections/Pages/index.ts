...
import { enforceTocTitle, populateTableOfContents } from '../../hooks/populateTableOfContents'
...
export const Pages: CollectionConfig<'pages'> = {
  ...
  hooks: {
    beforeValidate: [ensurePageSlugUniqueAcrossLandingPages, enforceTocTitle],
