...
> Note: this `useTranslation` example is for Payload **Admin** custom components only.  
> Frontend pages/components should use `createTranslator(...)` and pass `t` down via props.
